...
<body>
  <?php include "cabeceramenu2.php"; ?>
       ...
       <div class="container" style="margin-top:50px">
            <div class="row">
				<div class="col-md-9">
					<h2 class="sub-header">Mensajes</h2>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title-form" id="myModalLabel">Mensaje</h4>
				</div>
				<form role="form" name="" id="" method="post" action="">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input id="" class="form-control" type="text" name="" value="" title="Ingrese un mensaje" required />
						</div>
					</div>
	...
	<div class="modal fade" id="myModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalDeleteLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalDeleteLabel">Eliminación de Mensaje</h4>
				</div>
				<form role="form" name="" id="" method="post" action="">
					<input type="hidden" name="" id="" value="" />
					<input type="hidden" name="Accion" id="Accion" value="" />
					<div class="modal-body">
						<div class="input-group">
							<label for="pregunta">¿Está Seguro de eliminar el Mensaje seleccionado?</label>
						</div>       
						<div class="input-group">
							<label for="">Mensaje</label>
